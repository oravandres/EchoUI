...
# VITE_ECHO_API_BASE_URL is baked into the bundle at build time and validated
...
ARG VITE_ECHO_API_BASE_URL=https://echo.mimi.local
ENV VITE_ECHO_API_BASE_URL=${VITE_ECHO_API_BASE_URL}
RUN npm run build
